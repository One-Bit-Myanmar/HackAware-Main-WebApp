...
import { Shield, MessageSquare, BookOpen, FileSearch, AlertTriangle, ChevronRight } from "lucide-react"
    ...
    <main className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-950">
      <header className="container mx-auto py-6 px-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center gap-6">
          ...
          <Button asChild variant="outline" className="border-cyan-500 text-cyan-500 hover:bg-cyan-950">
      ...
      <section className="container mx-auto py-20 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <FeatureCard
            ...
            title="Smart Chat"
            description="Intelligent conversation with security insights and threat detection"
            link="/chat"
          />
          <FeatureCard
          ...
          <FeatureCard
            ...
            description="Step-by-step guidance to handle security incidents"
            link="/incident"
          />
        </div>
      </section>
